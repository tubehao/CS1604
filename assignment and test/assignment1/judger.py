...
exec_name = {
    '1_digit_sum': ['main.cpp', 'digit_sum'],
    '2_top2_number': ['main.cpp', 'top2_number'],
    '3_3n+1': ['main.cpp', '3n+1'],
    '4_pi_approximation': ['main.cpp', 'pi'],
    '5_prime_factorization': ['main.cpp', 'prime'],
}
